  ...
  return (
    <section className="space-y-6">
      <header className="glass-panel rounded-[2rem] p-6 sm:p-8">
        <p className="text-xs uppercase tracking-[0.35em] text-cyan-300/70">Phân loại tài chính</p>
        <h3 className="mt-3 text-3xl font-semibold text-white">Quản lý danh mục</h3>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-300">
          Tùy chỉnh và quản lý phân loại danh mục Thu nhập và Chi tiêu linh hoạt theo nhu cầu quản lý tài chính của bạn.
        </p>

        <div className="mt-5 flex flex-wrap gap-2">
          {["Danh mục Thu nhập", "Danh mục Chi tiêu", "Tự động phân loại"].map((chip) => (
